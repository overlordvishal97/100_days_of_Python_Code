...
#  I got the data for quiz from this website https://opentdb.com/ using api change the data if you want but remove response and results from the data inorder to acquire the data just paste the obtained api in the browser and copy the data from the browser and paste it in the data.py file.